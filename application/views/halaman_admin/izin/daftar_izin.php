                ...
                <div class="card">
                    <div class="card-header">
						...
						<div class="float-right">
							<a href="<?=base_url()?>index.php/perizinan/tambah_izin/<?= $data_pegawai['id'] ?>" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> &nbsp; Tambah Izin</a>&nbsp;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a class="btn disabled btn-success btn-sm" href="<?=base_url()?>index.php/perizinan/edit_izin/<?=$di['id']?>/<?=$di['id_pegawai']?>"><i class="fas fa-pencil-alt"></i></a>
                                            <a class="btn disabled btn-danger btn-sm" href="<?=base_url()?>index.php/perizinan/hapus_izin/<?=$di['id']?>/<?=$di['id_pegawai']?>" onclick="return confirm('Yakin akan menghapus data?');"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                $no++;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a class="btn btn-success btn-sm" href="<?=base_url()?>index.php/perizinan/edit_izin/<?=$di['id']?>/<?=$di['id_pegawai']?>"><i class="fas fa-pencil-alt"></i></a>
                                            <a class="btn btn-danger btn-sm" href="<?=base_url()?>index.php/perizinan/hapus_izin/<?=$di['id']?>/<?=$di['id_pegawai']?>" onclick="return confirm('Yakin akan menghapus data?');"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                    endif;

        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <form method="post" action="<?= base_url()?>index.php/perizinan/proses_tambah_izin/<?= $data_pegawai['id'] ?>" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-xl-6 col-sm-12 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <strong>Tambah Izin Tidak Masuk</strong>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control datepicker" name="tanggal_surat_izin">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="alasan_izin" id="alasan_izin"></textarea>
                                </div>
                                <div class="form-group">
                                    <label><strong>Alamat Saat Izin</strong></label>
                                    <textarea class="form-control" name="alamat_izin" id="alamat_izin"></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control datepicker" name="tanggal_mulai_izin">
                                        <div class="input-group-append">
                                            <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                        </div>
                                    </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control datepicker" name="tanggal_selesai_izin">
                                        <div class="input-group-append">
                                            <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="lama_izin">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="float-right mt-4">
                            ...
                            <a href="<?= base_url() ?>index.php/perizinan/daftar_izin/<?= $data_pegawai['id'] ?>" class="btn btn-danger btn-sm"><i class="far fa-window-close"></i> &nbsp; Batal</a>
                        </div>
                    </div>
                </div>
            </form>

        ...
        <div class="container-fluid">
            ...
            <form method="post" action="<?= base_url() ?>index.php/admin/proses_update_pns/<?=$data_user['id']?>" enctype="multipart/form-data">
                <div class="row mt-4">
                    ...
                    <div class="col-xl-6 col-sm-12 mb-4">
                        ...
                        <div class="float-right mt-4">
                            ...
                            <a href="<?= base_url() ?>index.php/admin/pns/<?=$data_user['id']?>" class="btn btn-danger btn-sm"><i class="far fa-window-close"></i> &nbsp; Batal</a>
                        </div>

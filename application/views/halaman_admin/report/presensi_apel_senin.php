        ...
        <div class="container-fluid">
			...
			<div class="col mt-3">
				...
				<form method="post" action="<?= base_url()?>index.php/report/presensi_apel_senin">
					...
					<div class="card">
						<div class="card-header">
							<strong>Data Presensi Apel Senin - <?= tgl_indo2($period) ?></strong>
                            <div class="float-right">
                                <a href="<?= base_url()?>index.php/report/cetak_presensi_apel_senin/<?= $period ?>" class="btn btn-primary btn-sm"><i class="fas fa-print"></i> &nbsp; Export</a>&nbsp;
                            </div>
						</div>
						<div class="card-body">
							...
							<div class="table-responsive">
								<table class="table table-sm table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
									...
									<?php 
									$no = 1;
									foreach ($presensi_senin as $data):
									?>
										<tr>

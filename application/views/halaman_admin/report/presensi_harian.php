        ...
        <div class="container-fluid">
			...
			<div class="col mt-3">
				...
				<form method="post" action="<?= base_url()?>index.php/report/presensi_harian">
					...
					<div class="card">
						<div class="card-header">
							<strong>Data Presensi - <?= tgl_indo2($period) ?></strong>
                            <div class="float-right">
                                <a href="<?= base_url()?>index.php/report/cetak_presensi_harian/<?= $period ?>" class="btn btn-primary btn-sm"><i class="fas fa-print"></i> &nbsp; Export</a>&nbsp;
                            </div>
						</div>
						<div class="card-body">

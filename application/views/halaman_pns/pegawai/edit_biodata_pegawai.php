        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <form method="post" action="<?=base_url()?>index.php/pegawai/proses_update_biodata" enctype="multipart/form-data">
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <img class="img-profile rounded-circle" src="<?=base_url('dokumen_foto/').$profile['file_foto']?>" width="80">
                    ...
                    <div class="col-xl-6 col-sm-12 mb-4">
                        ...
                        <div class="float-right mt-4">
                            ...
                            <a href="<?=base_url()?>index.php/pegawai/biodata_pegawai" class="btn btn-danger btn-sm"><i class="far fa-window-close"></i> &nbsp; Batal</a>
                        </div>

                ...
                <div class="card">
                    <div class="card-header">
						...
						<div class="float-right">
							<a href="<?=base_url()?>index.php/cuti_pegawai/tambah_cuti_pegawai" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> &nbsp; Tambah Cuti</a>&nbsp;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a class="btn btn-success btn-sm" href="<?=base_url()?>index.php/cuti_pegawai/edit_cuti/<?=$dc['id']?>/<?=$dc['id_pegawai']?>"><i class="fas fa-pencil-alt"></i></a>
                                            <a class="btn btn-danger btn-sm" href="<?=base_url()?>index.php/cuti_pegawai/hapus_cuti/<?=$dc['id']?>/<?=$dc['id_pegawai']?>" onclick="return confirm('Yakin akan menghapus data?');"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                    endif;

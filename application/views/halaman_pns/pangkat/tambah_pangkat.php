        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <form method="post" action="<?=base_url()?>index.php/pangkat/proses_tambah_pangkat" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-sm-12 mb-4">
                        ...
                        <div class="float-right mt-4">
							...
							<a href="<?=base_url()?>index.php/pangkat/pangkat" class="btn btn-danger btn-sm"><i class="far fa-window-close"></i> &nbsp; Batal</a>
                        </div>
